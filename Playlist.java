...
public class Playlist
{
	...
	{
		if(index >=0 && index<contents.size()) //checking is index valid
		{
			contents.get(index).play();//playing content
		}
	...
	{
		if (other instanceof Playlist) //checking if input is instance of playlist
		{
			Playlist another = (Playlist) other; //changing object other to playlist
			return this.title.equals(another.title); //return if equal or not
		}
		return false;
	}
